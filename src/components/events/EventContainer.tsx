...
const EventContainer = () => {
  const eventsData = [
    { title: "Event 1", description: "Join us for an epic tournament", image: "https://picsum.photos/seed/event1/350", category: "Tournament" },
    { title: "Event 2", description: "Experience the thrill of competition", image: "https://picsum.photos/seed/event3/350", category: "Competition" },
    { title: "Event 3", description: "Witness the battle of champions", image: "https://picsum.photos/seed/event5/350", category: "Championship" },
    { title: "Event 4", description: "The ultimate showdown awaits", image: "https://picsum.photos/seed/event7/350", category: "Showdown" },
    { title: "Event 5", description: "Glory and honor on the line", image: "https://picsum.photos/seed/event9/350", category: "Challenge" },
    { title: "Event 6", description: "Face your destiny in the arena", image: "https://picsum.photos/seed/event11/350", category: "Battle" },
    { title: "Event 7", description: "Prove your worth among the best", image: "https://picsum.photos/seed/event13/350", category: "Trial" },
    { title: "Event 8", description: "The final test begins here", image: "https://picsum.photos/seed/event15/350", category: "Finals" },
  ];
